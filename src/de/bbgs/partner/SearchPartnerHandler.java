 ...
 *
 */
public class SearchPartnerHandler implements IXmlServiceHandler
{
    /* (non-Javadoc)
        ...
        try
        {
            ...
            if (req.search != null && req.search.trim().length() != 0)
            {
                ...
                stmt = conn.prepareStatement(
                    "select * from partner where name like ? or zipcode like ? or city like ? or street like ? order by name");
    ...
    @XmlRootElement(name = "search-partner-req")
    @XmlType(name = "SearchPartnerHandler.Request")
    ...
    @XmlRootElement(name = "search-partner-ok-rsp")
    @XmlType(name = "SearchPartnerHandler.Response")
    public static class Response implements IJAXBObject
    {
        @XmlElementWrapper(name = "partners")
        @XmlElement(name = "partner")
        public Collection<Partner> found = new ArrayList<>();
    }
}
