 ...
 *
 */
public class GetCourseTerminModelHandler implements IXmlServiceHandler
{
    /* (non-Javadoc)
    ...
    public IJAXBObject handleRequest(IJAXBObject request, SessionWrapper session)
    {
        ...
        try
        {
            ...
            if (req.terminId == 0)
            {
                rsp = new CourseTerminModel();
            }
            else
            {
                conn = ConnectionPool.getConnection();
                rsp = CourseDBUtil.getCourseTerminModel(req.terminId, conn);
            }
        }
    ...
    @XmlRootElement(name = "get-course-termin-request")
    @XmlType(name = "GetCourseTerminHandler.Request")
    public static class Request implements IJAXBObject
    {
        @XmlElement(name = "id")
        public int terminId = 0;
    }
}
