 ...
 *
 */
public class SaveCourseTerminModelHandler implements IXmlServiceHandler
{
    /* (non-Javadoc)
    ...
    {
        return CourseTerminModel.class;
    }
    ...
    public Collection<Class<? extends IJAXBObject>> getUsedJaxbClasses()
    {
        ...
        result.add(CourseTerminModel.class);
        return result;
    }
    ...
    public IJAXBObject handleRequest(IJAXBObject request, SessionWrapper session)
    {
        ...
        try
        {
            CourseTerminModel model = (CourseTerminModel) request;

            conn = ConnectionPool.getConnection();
            CourseDBUtil.saveCourseTerminModel(model, session, conn);
            rsp = new Response();
        }
    ...
    @XmlRootElement(name = "save-course-termin-ok-response")
    @XmlType(name = "SaveCourseTerminHandler.Response")
