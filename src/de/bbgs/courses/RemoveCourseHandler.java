 ...
 *
 */
public class RemoveCourseHandler implements IXmlServiceHandler
{
    ...
    public IJAXBObject handleRequest(IJAXBObject request, SessionWrapper session)
    {
        ...
        try
        {
            ...
            CourseDBUtil.deleteCourse(req.id, conn);
            rsp = new Response();
        }
    ...
    @XmlRootElement(name = "remove-course-request")
    @XmlType(name = "RemoveCourseHandler.Request")
    ...
    @XmlRootElement(name = "remove-course-ok-response")
    @XmlType(name = "RemoveCourseHandler.Response")
