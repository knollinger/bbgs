 ...
 *
 */
public class RemoveFileSystemObjectHandler implements IXmlServiceHandler
{
    /* (non-Javadoc)
    ...
    public IJAXBObject handleRequest(IJAXBObject request, SessionWrapper session)
    {
        ...
        try
        {
            ...
            FileSystemDBUtils.removeObject(req.id, conn);
    ...
    @XmlRootElement(name = "remove-filesystem-object-req")
    @XmlType(name = "RemoveFileSystemObjectHandler.Request")
    ...
    @XmlRootElement(name = "remove-filesystem-object-ok-rsp")
    @XmlType(name = "RemoveFileSystemObjectHandler.Response")
