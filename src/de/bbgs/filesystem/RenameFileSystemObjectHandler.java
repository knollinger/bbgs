 ...
 *
 */
public class RenameFileSystemObjectHandler implements IXmlServiceHandler
{
    /* (non-Javadoc)
    ...
    public IJAXBObject handleRequest(IJAXBObject request, SessionWrapper session)
    {
        ...
        try
        {
            ...
            FileSystemDBUtils.renameObject(req.id, req.name, conn);
            rsp = new Response();
        }
    ...
    @XmlRootElement(name = "rename-filesystem-object-req")
    @XmlType(name = "RenameFileSystemObjectHandler.Request")
    ...
    @XmlRootElement(name = "rename-filesystem-object-ok-rsp")
    @XmlType(name = "RenameFileSystemObjectHandler.Response")
