 ...
 *
 */
public class SaveCustomMailGroupHandler implements IXmlServiceHandler
{
    ...
    {
        return CustomMailGroupModel.class;
    }
    ...
    public Collection<Class<? extends IJAXBObject>> getUsedJaxbClasses()
    {
        ...
        result.add(CustomMailGroupModel.class);
    ...
    public IJAXBObject handleRequest(IJAXBObject request, SessionWrapper session)
    {
        ...
        try
        {
            ...
            CustomMailGroupModel model = (CustomMailGroupModel)request;
            MailDBUtils.saveCustomMailGroupModel(model, conn);
            conn.commit();
            return new Response();
        }
    ...
    @XmlRootElement(name = "save-custom-mail-group-ok-rsp")
    @XmlType(name = "SaveCustomMailGroupHandler.Response")
