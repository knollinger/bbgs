 ...
 *
 */
public class GetCustomMailGroupHandler implements IXmlServiceHandler
{
    ...
    public IJAXBObject handleRequest(IJAXBObject request, SessionWrapper session)
    {
        ...
        try
        {
            ...
            return MailDBUtils.getCustomGroupModel(req.id, conn);
        }
    ...
    @XmlRootElement(name = "get-custom-mail-group-req")
    @XmlType(name = "GetCustomMailGroupHandler.Request")
