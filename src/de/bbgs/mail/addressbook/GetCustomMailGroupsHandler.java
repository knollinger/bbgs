 ...
 *
 */
public class GetCustomMailGroupsHandler implements IXmlServiceHandler
{
    ...
    @XmlRootElement(name = "get-custom-mail-groups-req")
    @XmlType(name = "GetCustomMailGroupsHandler.Request")
    public static class Request implements IJAXBObject
    {

    }
    
    @XmlRootElement(name = "get-custom-mail-groups-ok-rsp")
    @XmlType(name = "GetCustomMailGroupsHandler.Response")
