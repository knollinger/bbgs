 ...
 * Der MemberSelector
 */
var MemberSelector = function(multiSelect, onSubmit) {
    ...
    var self = this;
    this.load("gui/member/member_selector.html", function() {
 ...
 * 
 */
MemberSelector.prototype.fillTable = function(multiselect) {
 ...
 * 
 */
MemberSelector.prototype.onResultSetSelection = function(tr, member) {
 ...
 */
MemberSelector.prototype.onSave = function() {
 ...
 * 
 */
MemberSelector.prototype.onSelectionChange = function(selection) {
 ...
 * MemberOverview
 * 
 * Eine spezialisierung des MemberSelectors, welche noch die Actions AddMember,
 * EditMember und RemoveMember einbringt
 */
var MemberOverview = function() {

    MemberSelector.call(this, false, null);
